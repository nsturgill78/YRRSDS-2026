...
export const metadata: Metadata = {
  title: "Participating",
  description: "Participation, travel, and local logistics information for YRRSDS 2026 on August 2, 2026.",
};
      ...
      <div className="container-page">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <InfoCard title="Research roundtable">
            ...
            <p>
              The afternoon schedule is now published; any room-specific details will be added as SIGDIAL logistics
              are finalized.
            </p>
          </InfoCard>
